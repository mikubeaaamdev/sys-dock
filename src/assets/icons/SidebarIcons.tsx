...
// Activity Monitor Icon - System Monitoring
...
// Refresh/Process Icon - Running Processes
...
// Weather/Cloud Icon - Environment
export const WeatherIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12.5 2C17 2 20.5 5.5 20.5 10c0 .88-.15 1.73-.42 2.51C21.24 13.36 22 14.61 22 16c0 2.21-1.79 4-4 4H7c-2.76 0-5-2.24-5-5 0-2.64 2.05-4.78 4.65-4.96C7.55 7.15 9.68 5.5 12.5 2z"/>
  </svg>
);

// Document/Logs Icon - File Management
